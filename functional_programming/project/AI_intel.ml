...
print_endline "";
print_string "IA enter the number of sticks you wish to remove:";

let verifchoisi m =
if v.(m).choisi =1 then
				print_string "IA you remove stick n° "
      else
      print_string "IA error";
in
...
let test n =
	...
	print_endline "IA, you're out of the picture.";
in
...
let affichebatonblanc nbre =
	let j = 
		print_endline "IA enter the first number in your sequence, which will be generated from left to right:";
...
(Random.int nombreenlever)+1 in
	...
	begin
			print_endline "IA you were wrong.";
	end
done;	

if somme_tableau_entiers v = 1 then
	begin
	print_endline "IA you've won";
	exit 0;
	end
else
	print_endline "";
